	        ...
	        <?php
	        	if ( have_posts() ) { $count = 0;
	        		while ( have_posts() ) { the_post(); $count++;
	        			...
	        			$image_src = get_post_meta( $post->ID, 'feature_icon', true );
	        ?>
				<article <?php post_class('fix'); ?>>
	                ...
	                <div class="post-body">
	                	...
	                	<?php echo woo_embed( 'width=580' ); ?>
	               		<?php if ( $settings['thumb_single'] == 'true' && ! woo_embed( '' ) && '' != $image_src ) { ?><img src="<?php echo $image_src; ?>" alt="" class="feature-thumb <?php echo $settings['thumb_single_align']; ?>" /><?php } ?>
