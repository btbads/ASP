...
if (!function_exists( 'the_widgets_init')) {
	function the_widgets_init() {
	    ...
	    register_sidebar(array( 'name' => 'Featured Motto','id' => 'wfeatured-motto', 'description' => "Widetized featured motto", 'before_widget' => '<div id="featured-motto">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	    register_sidebar(array( 'name' => 'Product Categories','id' => 'wprodcats', 'description' => "Widetized product categories", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	    register_sidebar(array( 'name' => 'Services','id' => 'wservices', 'description' => "Widetized services", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
