...
class WooCommerce_Widget_Related_Products extends WP_Widget {

	/** constructor */
	function __construct() {
		$this->id_base = 'woocommerce_related_products';
		$this->name    = __('WooCommerce Related Products', 'woocommerce' );
		$this->widget_options = array(
			'classname'   => 'widget_related_products',
			'description' => __( 'Display a list of related products on your site.', 'woocommerce' ),
		);
...
<!--				<?php //while ($query->have_posts()) : $query->the_post(); global $product; ?>
				...
				<?php //endwhile; ?>
-->			<?php echo woocommerce_related_products( 3, 1 ); ?>
			</ul>
			<?php
...
} // class WooCommerce_Widget_Related_Products